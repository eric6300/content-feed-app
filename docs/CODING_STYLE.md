...
- Dependency versions are centralized in `gradle/libs.versions.toml`. “Latest” means the latest stable release that resolves, compiles, and passes lint on the committed AGP/Kotlin/Gradle/compileSdk baseline recorded there.
